...
# Compatibility stub: RAGAS 0.4.x imports ChatVertexAI from old path removed in langchain-community 0.4+
...
SYSTEM_V1 = (
    ...
    "Chỉ dựa vào context sau để trả lời câu hỏi. "
    "Giữ câu trả lời ngắn gọn, rõ ràng (2-4 câu). "
    "Nếu không tìm thấy thông tin trong context, hãy thành thật nói không biết.\n\n"
    "Context:\n{context}"
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích thông tin AI với tư duy hệ thống. "
    "Khi nhận được câu hỏi, hãy: "
    "1) Đọc kỹ context và xác định các facts liên quan, "
    "2) Trình bày câu trả lời có cấu trúc rõ ràng (3-5 câu), "
    "3) Trích dẫn thông tin cụ thể từ context để hỗ trợ lập luận. "
    "Chỉ dựa vào dữ liệu được cung cấp, không suy đoán hoặc bịa đặt thêm.\n\n"
    "Context:\n{context}"
)
